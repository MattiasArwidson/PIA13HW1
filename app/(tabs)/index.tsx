    ...
    >
      ...
      <View style={[styles.defaultView, styles.defaultViewRow, {}]}>
        <View
          style={[
            styles.defaultView,
            { backgroundColor: "green", height: 90, flex: 1 },
          ]}
        >
        ...
        <View
          style={[styles.defaultView, { backgroundColor: "yellow", flex: 1 }]}
        ></View>
      </View>

      <View style={[styles.defaultView, styles.defaultViewRow, { height: 45 }]}>
        <View
          style={[styles.defaultView, { backgroundColor: "red", flex: 3 }]}
        />
        <View style={[styles.defaultView]} />
        <View
          style={[styles.defaultView, { backgroundColor: "black", flex: 1 }]}
        />
      </View>
